...
int stack_top(stack_t *stack, char *ch);
int stack_pop(stack_t *stack, char *data, int bytes);
int stack_push(stack_t *stack, const char *data, int bytes);
int stack_cleanup(stack_t *stack);
